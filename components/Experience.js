    ...
    return <div className={styles.container}>
        <div className={styles.cover}>
            <div className={styles.first_div}>
                ...
                <p className={styles.para2}> This is sort of a fun projrct i created some time ago just because i am a big fan of kanye west so i used his API </p>
        ...
        <div className={styles.cover1}>
            <div className={styles.second_div}>
                <p className={styles.para1}> Most of my previous work experience are not tech related,however most of my projects and upcoming peojects will be listed here , please watch out for this space</p>
            </div>
        </div>
    </div>
}
