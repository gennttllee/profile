    ...
    return <div>
        <button className={styles.divider}>
            <a target='blank' href='https://web.facebook.com/marckwilliamz'>
                <Image src='/static/facebook.jpg' alt='whatsapp' width={30} height={35}></Image>
            </a>
        </button>
        <button className={styles.divider}>
            <a target='blank' href='https://www.instagram.com/mark_williams_mw/'>
                <Image src='/static/instagram.jpg' alt='whatsapp' width={30} height={35}></Image>
            </a>
        </button>
        <button className={styles.divider}>
            <a target='blank' href='https://www.linkedin.com/in/malachi-udonkenta-98a77398/'>
                <Image src='/static/linkedin.png' alt='whatsapp' width={30} height={35}></Image>
            </a>
        </button>
        <button className={styles.divider}>
